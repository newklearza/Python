...
# This is a simulated dice roll application using error excepts, rules and a decreasing list.
...
search_list = [*range(low,hi)]
ranum = random.choice(search_list)
